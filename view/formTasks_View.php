...
<div id="form" class="container">
  <h5 class="header center-align">Formulaire Création Tâche</h5>
  <a href="../controller/single.php"><strong>Retour</strong></a>
<div class="row">

    <form class="col s10" action="../controller/tasks.php?join=<?php echo $_GET['join'];?>" method="post">
        ...
        <div class="input-field col s10">
           <input class="waves-effect btn light-blue darken-1" value="Envoyer" type="submit" name="envoi">
         </div>
